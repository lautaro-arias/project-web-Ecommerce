        ...
        <div className="carousel w-full hidden md:flex">
            <div id="slide1" className="carousel-item relative w-full carousel-inner" >
                {arrayCardValores.map((item) => (
                    <div key={item.id} className="m-1 text-center aleing-center backdrop-blur-lg transition-transform transform hover:scale-105 lg:w-1/4 md:w-1/2 p-4 w-full">
                        ...
                        <div className="mt-4">
                            ...
                            <h2 className="text-gray-400 dark:text-slate-400 title-font text-lg font-medium">{item.title}</h2>
                            <p className="mt-1 text-gray-400 dark:text-slate-400 ">{item.precio}</p>
                        </div>
                    </div>
                ))}
            </div>
