...
export default function Nav() {
    ...
    return (
        <>
              ...
              <div className={`navbar ${bgColor ? bgColor : 'bg-white'} transparent  ${textColor} max-w-screen-xl  md:rounded-full  p-0 fixed top-0  left-1/2 transform -translate-x-1/2 z-[1]`}>
                    <div className="navbar-start">
                        <div className="dropdown">
                            ...
                            <ul
                                tabIndex={0}
                                className="ml-2 text-black menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
                        ...
                        <ul className="menu menu-horizontal px-1">
                            ...
                            <li className='mt-2 font-bold'>
                                <details>
                                    ...
                                    <ul className="p-2">
                                        <li><button onClick={() => scrollToSection('')} className="btn btn-ghost">
                                            <a>Lo mas pedido</a>
                                        </button>
                                        </li>
                                        {/*<li><a></a></li>*/}
